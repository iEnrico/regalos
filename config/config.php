...
define("DB_NAME", "regalos");
define("DB_USER", "regalos");
define("DB_PASS", "u67V3fTqunuvF9Jp");
...
define("EMAIL_SMTP_HOST", "ssl://smtp.gmail.com");
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "enric.malras@gmail.com");
define("EMAIL_SMTP_PASSWORD", "UlG.vqBY171130");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", "ssl");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://barcelonaregalos.dev/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@barcelonaregalos.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Barcelona Regalos");
define("EMAIL_PASSWORDRESET_SUBJECT", "Cambio de contrase&ntilde; Barcelona Regalos");
define("EMAIL_PASSWORDRESET_CONTENT", "Por favor haga click en este enlace para cambiar su contrase&ntilde;a:");

/**
 * Configuration for: verification email data
 * Set the absolute URL to register.php, necessary for email verification links
 */
define("EMAIL_VERIFICATION_URL", "http://barcelonaregalos.dev/register.php");
define("EMAIL_VERIFICATION_FROM", "no-reply@barcelonaregalos.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Barcelona Regalos");
define("EMAIL_VERIFICATION_SUBJECT", "Activaci&oacute;n de la cuenta Barcelona Regalos");
define("EMAIL_VERIFICATION_CONTENT", "Por favor haga click aqu&iacute; para activar su cuenta:");
